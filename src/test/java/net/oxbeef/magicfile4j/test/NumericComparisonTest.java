...
public class NumericComparisonTest extends AbstractMagicTest {
	...
	public void testNotEqualComparisonByte() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("0006");
	...
	public void testGTComparisonByte() throws IOException {
		...
		byte[] objpart = StringUtils.hex2Bytes("0606");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("0306");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}

	public void testLTComparisonByte() throws IOException {
		String magicFile = "0 byte <5 match";
		byte[] objpart = StringUtils.hex2Bytes("0206");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("0806");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}

	public void testANDComparisonByte() throws IOException {
		String magicFile = "0 byte &3 match";
		byte[] objpart = StringUtils.hex2Bytes("0706");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
	...
	public void testXORComparisonByte() throws IOException {
		...
		byte[] objpart = StringUtils.hex2Bytes("CA");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("CE");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}

	public void testNegateComparisonByte() throws IOException {
		String magicFile = "0 byte ~3 match";
		byte[] objpart = StringUtils.hex2Bytes("FC");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("FF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testUnsignedByteGT() throws IOException {
		...
		byte[] objpart = StringUtils.hex2Bytes("FF");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");

		objpart = StringUtils.hex2Bytes("F1");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("EF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("AA");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("80");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("7F");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("00");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	...
	public void testSignedByteGT() throws IOException {
		...
		// higher always
		byte[] objpart = StringUtils.hex2Bytes("F1");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		objpart = StringUtils.hex2Bytes("FF");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
	...
	public void testANDComparisonShort() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("FFF4");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testXORComparisonShort() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("FFCE");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testNegateComparisonShort() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("FFFE");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testShortWithMask() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("000F");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");

		objpart = StringUtils.hex2Bytes("0009");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");

		objpart = StringUtils.hex2Bytes("0008");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");

		// fail bc not gt 7
		objpart = StringUtils.hex2Bytes("0007");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);



		objpart = StringUtils.hex2Bytes("FFF3");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("FFF0");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testUnsignedShortGT() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("F001");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("EFFF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("AAAA");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("8000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("7FFF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("0000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	...
	public void testSignedShortGT() throws IOException {
		...
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		objpart = StringUtils.hex2Bytes("FFFF");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
	...
	public void testUnsignedLongGT() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("F0000001");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		
		objpart = StringUtils.hex2Bytes("EFFFFFFF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("AAAAAAAA");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
		
		objpart = StringUtils.hex2Bytes("80000000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("7FFFFFFF");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);

		objpart = StringUtils.hex2Bytes("00000000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	...
	public void testSignedLongGT() throws IOException {
		...
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
		objpart = StringUtils.hex2Bytes("FFFFFFFF");
		runMagicAndFileTestOp(magicFile, objpart, "Test: match");
	...
	public void testNotEqualComparisonQuad() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("0000000000000000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
	...
	public void testGTComparisonQuad() throws IOException {
		...
		objpart = StringUtils.hex2Bytes("8000000000000000");
		runMagicAndFileTestOpNullMatch(magicFile, objpart);
	}
